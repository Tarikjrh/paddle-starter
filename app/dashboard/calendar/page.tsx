      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            View and manage all court bookings in calendar format
          </p>
        </div>
        ...
        <CardContent>
          ...
          <div className="grid grid-cols-7 gap-1">
            ...
            {["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"].map((day) => (
              <div
                key={day}
                className="p-2 text-center font-semibold text-sm text-gray-600 border-b"
              >
                {day}
              </div>
            ))}
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3 p-4 bg-gray-50 rounded-lg">
                <div className="flex items-center space-x-2">
                  ...
                  <Badge variant="secondary">
                    ${selectedBooking.courts?.hourly_rate}/hr
                  </Badge>
                </div>
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span>
                    {formatDate(new Date(selectedBooking.booking_date))}
                  </span>
                </div>
              ...
              <div className="flex space-x-3">
                ...
                <Button
                  ...
                  disabled={
                    editingStatus === selectedBooking.status &&
                    editingNotes === (selectedBooking.notes || "")
                  }
                >
